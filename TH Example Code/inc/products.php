...
//retrieves an individual product array from the database based on the product sku
//returns false if there is no match for the sku
//@param int $sku
//@return mixed array
//        bool false
